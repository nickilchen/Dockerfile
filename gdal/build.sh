...
# 配置变量
REGISTRY=${REGISTRY:-""}
IMAGE_NAME=${IMAGE_NAME:-"gdal-multi-arch"}
TAG=${TAG:-"latest"}
...
setup_builder() {
    ...
    BUILDER_NAME="gdal-multiarch-builder"
...
环境变量:
    ...
    CLEANUP_CACHE              是否清理缓存 (true/false)
